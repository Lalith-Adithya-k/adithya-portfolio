...
<table>
  <tr>
    <td width="50%">
      <strong>📱 For iOS Users</strong><br><br>
      <ol>
      ...
      <br>
      <strong>🤖 For Android Users</strong><br><br>
      <ol>
    ...
    <td width="50%">
      <img src="../assets/images/swiggy/Install.png" width="100%">
      <br>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td width="50%">
      <img src="../assets/images/swiggy/Main%20login.png" height="120%" width="100%">
      <br>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%">
      <strong>To add a delivery address:</strong><br><br>
      <ol>
    ...
    <td width="50%">
      <img src="../assets/images/swiggy/Address.png" width="100%">
      <br>
...
<table>
  <tr>
    <td width="50%">
      <strong>Payment Method Setup</strong><br><br>
      <ol>
    ...
    <td width="50%">
      <img src="../assets/images/swiggy/Payment.png" width="100%">
      <br>
...
<table>
  <tr>
    <td width="50%">
      <strong>Three ways to find restaurants:</strong><br><br>
      <ul>
    ...
    <td width="50%">
      <img src="../assets/images/swiggy/Home%20and%20filter.png"  width="100%">
      <br>
...
<table>
  <tr>
    <td width="50%">
      <strong>To add an item:</strong><br><br>
      <ol>
    ...
    <td width="50%">
      <img src="../assets/images/swiggy/item%20add%20on.png"  width="100%">
      <br>
...
<table>
  <tr>
    <td width="50%">
      <strong>To apply a coupon:</strong><br><br>
      <ol>
      ...
      <br>
      <strong>To complete checkout:</strong><br><br>
      <ol>
    ...
    <td width="50%">
      <img src="../assets/images/swiggy/Checkout.png" width="100%">
      <br>
...
<table>
  <tr>
    <td width="50%">
      <strong>Order tracking stages:</strong><br><br>
      <ul>
    ...
    <td width="50%">
      <img src="../assets/images/swiggy/Delivery.png"  width="100%">
      <br>
...
<table>
  <tr>
    ...
    <td width="50%">
      <img src="../assets/images/swiggy/Screenshot%202026-03-27%20134454.png" width="100%">
      <br>
...
<table>
  <tr>
    <td width="50%">
      <strong>To report issues:</strong><br><br>
      <ol>
    ...
    <td width="50%">
      <img src="../assets/images/swiggy/report%20issue.png" width="100%">
      <br>
...
<table>
  <tr>
    ...
    <td width="50%">
      <img src="../assets/images/swiggy/Refundss.png" width="100%">
      <br>
